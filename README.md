...
| :--- | :---: | :--- |
| **Jundi Haidar Prayudi** | 21060125120018 | <ul><li>Menyusun kode program visualisasi Kategori A (Agregasi) </li><li>Membuat struktur dan mengatur manajemen repositori GitHub</li><li>Memperbaiki kode _deprecated_</li></ul> |
